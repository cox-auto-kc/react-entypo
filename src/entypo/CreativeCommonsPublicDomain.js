...
const iconClass = 'entypo-svgicon entypo--CreativeCommonsPublicDomain';

let EntypoCreativeCommonsPublicDomain = (props) => (
...
export default EntypoCreativeCommonsPublicDomain;
