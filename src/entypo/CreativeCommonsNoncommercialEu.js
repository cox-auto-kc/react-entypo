...
const iconClass = 'entypo-svgicon entypo--CreativeCommonsNoncommercialEu';

let EntypoCreativeCommonsNoncommercialEu = (props) => (
...
export default EntypoCreativeCommonsNoncommercialEu;
