...
const iconClass = 'entypo-svgicon entypo--creativeCommonsNoncommercialUs';

let EntypoCreativeCommonsNoncommercialUs = (props) => (
...
export default EntypoCreativeCommonsNoncommercialUs;
