...
const iconClass = 'entypo-svgicon entypo--CreativeCommonsSharealike';

let EntypoCreativeCommonsSharealike = (props) => (
...
export default EntypoCreativeCommonsSharealike;
